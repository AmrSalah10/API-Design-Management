 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calc.com/", wsdlLocation = "file:/D:/Studying/API%20Design/SOAP/Service/calculator.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calc.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Studying/API%20Design/SOAP/Service/calculator.wsdl");
    ...
    public CalculatorPortType getCalculatorPort() {
        return super.getPort(new QName("http://calc.com/", "CalculatorPort"), CalculatorPortType.class);
    }
    ...
    public CalculatorPortType getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.com/", "CalculatorPort"), CalculatorPortType.class, features);
    }
